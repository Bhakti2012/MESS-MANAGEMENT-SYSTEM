...
<div class="col-md-12 col-md-offset-3" >
			...
			<table style="width: 100%" border="1">
			 <tr>
			<td><label for="txt_Uname" style="color:White;font-size:18px;">Select Roll:</label></td>
		    <td >
  ...
  <option value="Mess">Mess Info</option>
 </select>
		    </tr>
		    <tr>
		    <td><br/></td>
	       ...
	       <tr>
			<td ><label for="txt_Uname" style="color:White;font-size:18px;">Email_ID:</label></td>
		    <td ><input type="text" class="form-control" name="txt_Uname"  required id="txt_Uname" placeholder="Enter Name"></td>
		    </tr>
		 <tr>
		    <td><br/></td>
		     <td><br/></td>
		    ...
		    <tr>
			<td ><label for="txt_Password" style="color:White;font-size:18px;">Password:</label></td>
			<td ><input type="password" class="form-control" name="txt_Password" required id="txt_Password" placeholder="Enter Password"></td>
			</tr>
			 <tr>
		    <td><br/></td>
		     <td><br/></td>
