...
<body>	
			...
			<form name="shareFile" action="U_BuyProduct.jsp" method="post">
			<div align="center">
...
%>
			<tr>
			<td ><label for="txt_Pid" style="color:Black;font-size:18px;"><input type="radio" name="rd_group" value="<%=id %>" > <%=id %></label></td>
...
<%
	...
	%>
	<tr><td><input type="submit" name="Submit" value="Buy" />
	<!-- <a href="U_BuyProduct.jsp">
			<input type="button" class="btn btn-success" value="Buy"></a> -->
	</td>
	</tr>
